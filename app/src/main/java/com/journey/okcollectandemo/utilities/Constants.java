package com.journey.okcollectandemo.utilities;

public class Constants {

    public final static boolean productionVersion = false;
    public final static boolean EXTERNAL = false;
    public final static boolean SANDBOX = false;
    public final static boolean DEVMASTER = true;
    ...
    public static final int VERIFITED_FALSE = 2;
